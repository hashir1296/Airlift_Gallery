...
public abstract class Hilt_MyCollectionFragment<Binding extends ViewBinding, VM extends ViewModel> extends BaseFragment<Binding, VM> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MyCollectionFragment_GeneratedInjector) this.generatedComponent()).injectMyCollectionFragment(UnsafeCasts.<MyCollectionFragment>unsafeCast(this));
    }
  }
