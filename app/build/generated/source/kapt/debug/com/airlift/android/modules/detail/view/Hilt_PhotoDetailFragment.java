...
public abstract class Hilt_PhotoDetailFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PhotoDetailFragment() {
    super();
  }

  Hilt_PhotoDetailFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PhotoDetailFragment_GeneratedInjector) this.generatedComponent()).injectPhotoDetailFragment(UnsafeCasts.<PhotoDetailFragment>unsafeCast(this));
    }
  }
