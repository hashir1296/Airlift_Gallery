...
public abstract class Hilt_CuratedPhotosListFragment<Binding extends ViewBinding, VM extends ViewModel> extends BaseFragment<Binding, VM> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CuratedPhotosListFragment_GeneratedInjector) this.generatedComponent()).injectCuratedPhotosListFragment(UnsafeCasts.<CuratedPhotosListFragment>unsafeCast(this));
    }
  }
