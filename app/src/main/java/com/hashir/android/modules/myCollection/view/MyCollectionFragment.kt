package com.hashir.android.modules.myCollection.view
...
import com.hashir.android.databinding.FragmentMyCollectionBinding
import com.hashir.android.modules.base.BaseFragment
import com.hashir.android.modules.myCollection.MyCollectionAdapter
import com.hashir.android.modules.myCollection.viewmodel.MyCollectionListViewModel
...
class MyCollectionFragment :
    ...
    override fun setUpViews() {
        ...
        dialog.setContentView(com.hashir.android.R.layout.custom_image_dialog)
        zoomedImageView =
            dialog.findViewById<GestureImageView>(com.hashir.android.R.id.customImageView)
                ...
                viewLifecycleOwner.lifecycleScope.launch {
                    ...
                    withContext(Dispatchers.Main) {
                        Snackbar.make(requireActivity().findViewById(R.id.content),
                            getString(com.hashir.android.R.string.deleted),
